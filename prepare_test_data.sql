use database demo_db; -- change DB
create schema if not exists refiner; --change schema
use schema refiner; --change schema


CREATE OR REPLACE TABLE table_comparison_audit (
...
--create test data
------------------
create or replace table table_x (id int, name varchar, age int); 
create or replace table table_y (id int, age int, name varchar); 
create or replace table table_z (id int, name varchar); 
create or replace table table_x2 (id int, name varchar, age int); 
create or replace table table_x3 (id int, name varchar, age int); 
create or replace table table_x4 (id int, name varchar, age int); 
create or replace table table_x5 (id int, name varchar, age int); 
create or replace table table_x6 (id int, name varchar, age int, batch_id int); 
create or replace table table_x7 (id int, name varchar, age int, batch_id int); 
create or replace table table_x8 (id int, name varchar, age int, batch_id int); 

insert into table_x values (1, 'john', 10), (2, 'susan', 15), (3, 'brad', 20), (4, 'bill', 1000); 
insert into table_x2 values (1, 'john', 10), (2, 'susan', 15), (3, 'brad', 20), (4, 'bill', 1000); 
insert into table_y values (1, 10, 'john'), (2, 15, 'susan'), (3, 20, 'brad'), (4, 1000, 'bill'); 
insert into table_z values (1, 'john'), (2, 'susan'), (3, 'brad'), (4, 'bill'); 
insert into table_x3 values (1, 'john', 10), (2, 'susan', 15), (3, 'brad', 20); 
insert into table_x4 values (4, 'bill', 1000), (3, 'brad', 20), (2, 'susan', 15), (1, 'john', 10); 
insert into table_x5 values (4, 'bill', 1), (3, 'brad', 2), (2, 'susan', 15000), (1, 'john', 10); 
insert into table_x6 values (4, 'bill', 1,1), (3, 'brad', 2,1), (2, 'susan', 15000,2), (1, 'john', 10,3); 
insert into table_x7 values (4, 'bill', 1,1), (3, 'brad', 2,2), (2, 'susan', 15000,3), (1, 'john', 10,4); 
insert into table_x8 values (4, 'bill', 1,1), (3, 'brad', 2,2), (2, 'susan', 15000,3), (1, 'john', 10,4); 
